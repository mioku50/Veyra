...
export const ALLOWED_TRANSITIONS: Record<ExecutionState, ExecutionState[]> = {
  ...
  EXECUTING: ["SUBMITTED", "EVALUATING", "SETTLING", "COMPLETED", "FAILED", "SETTLEMENT_FAILED", "EVALUATION_REJECTED"],
  SUBMITTED: ["EVALUATING", "SETTLING", "COMPLETED", "FAILED", "SETTLEMENT_FAILED", "EVALUATION_REJECTED"],
  EVALUATING: ["SETTLING", "COMPLETED", "FAILED", "SETTLEMENT_FAILED", "EVALUATION_REJECTED"],
  SETTLING: ["COMPLETED", "SETTLEMENT_FAILED", "FAILED"],
  COMPLETED: [], // Terminal
  REJECTED: [], // Terminal
  EXPIRED: [], // Terminal
  CANCELLED: [], // Terminal
