...
function ReceiptCard({ receipt }: { receipt: CommerceReceipt }) {
  return (
    <Card className="rounded-2xl border border-white/10 bg-[#090c13]/90 backdrop-blur-xl p-1 transition-all duration-300 hover:border-primary/40 hover:shadow-[0_0_30px_rgba(123,108,255,0.12)]">
