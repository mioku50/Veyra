    ...
    <div className="max-w-6xl mx-auto">
      ...
      >
        <TabsList className="w-full">
          <TabsTrigger value="payments">Agent Purchases</TabsTrigger>
      ...
      {!loading && activeData.length > 0 && (
        <div className="flex items-center justify-between border-x border-b rounded-b-lg px-4 py-3 text-sm">
          <span className="text-muted-foreground">
            {activeData.length} {activeTab === "payments" ? "agent purchase" : "withdrawal"}{activeData.length !== 1 ? "s" : ""} total
          </span>
